...
📢 以下是关于开发新方向的正在进行中的投票！我建议**所有看到此消息的朋友**参与这个只需 5 秒的匿名投票，以便开发者获得公正的结果。

- 🗳️ [`Smart Merge` 是否值得其所带来的开销？](https://github.com/hesprs/obsidian-webdav-sync/discussions/117)
...
- [ ] v2.6：使用 Uni-CRUD 统一远程和本地文件的 CRUD 接口
- [ ] v2.7：将加密重构为 Uni-CRUD 包装器
- [ ] v2.8：重新设计智能合并并使用 Uni-KV 统一存储层
- [ ] v2.9：重构核心同步流程以增强可扩展性，并使用 Uni-CRUD 进行批量操作
- [ ] v2.10：将整个架构重构为 SynthKernel
- [ ] v3.0：动态模块加载、模块商店、非对称存储以及品牌重塑
...
虽然本项目与 Nutstore 无关联，但感谢 Nutstore 提供的原型及开源贡献。截至 2026 年 5 月 2 日，约 32% 的工作量由 Nutstore 贡献。
