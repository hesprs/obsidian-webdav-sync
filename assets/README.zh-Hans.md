...
V3 的重写是该插件具有里程碑意义的重大版本更新，它在性能和模块化方面都取得了诸多突破。其中最具颠覆性的是其模块系统——V3 允许您以及您的 AI Agent 编写自定义模块并加载到插件中，从而无限扩展插件的功能。

目前 V3 的功能已开发完毕，正处于 Beta 测试阶段。如果您感兴趣，可以前往 [`feat/fs`](https://github.com/hesprs/obsidian-webdav-sync/tree/feat/fs) 分支了解更多详情。
...
- [x] v3.0：完全重写、动态模块加载、模块商店、非对称存储及品牌重塑
