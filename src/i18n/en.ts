const en = {
	...
	settings: {
		...
		v3Migration: {
			button: 'Migrate now',
			desc: 'Copy current settings and storage into Sync Engine.',
			failure: {
				body: 'Migration failed: {{error}}',
				close: 'Close',
				partialCleanup: 'Source cleanup may already have started.',
				rolledBack: 'Target artifacts were rolled back.',
				title: 'Migration failed',
			},
			name: 'Migrate to Sync Engine',
			progress: {
			...
			prompt: {
				body: 'This will copy your current settings and storage into Sync Engine. You can cancel, hide this prompt, or continue.',
				cancel: 'Cancel',
			...
			success: {
				body: 'Install or download Sync Engine, disable and delete WebDAV Sync.',
				close: 'Close',
				encryptionBody: 'Encryption was enabled. Reset remote data and re-sync.',
