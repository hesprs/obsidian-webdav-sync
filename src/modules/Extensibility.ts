...
export type Module = new (ctx: PluginContext) => object;
...
export default class Extensibility {
	...
	constructor(
		private readonly ctx: {
			app: App;
			__addModule__: PluginContext['__addModule__'];
			__getModule__: PluginContext['__getModule__'];
		},
	) {
	...
	private readonly loadModule = async (name: string) => {
		const module: Module = await import(
