...
| :-- | :-- | :-- |
| `packages` | Workspace boundary for distributable modules; currently hosts WebDAV explorer package(s). | [packages/codemap.md](./packages/codemap.md) |
| `packages/webdav-explorer` | Embeddable SolidJS WebDAV directory picker UI with folder creation and path-confirm callbacks. | [packages/webdav-explorer/codemap.md](./packages/webdav-explorer/codemap.md) |
