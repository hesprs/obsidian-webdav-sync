...
| `src/storage`       | Settings-backed persistence for sync-state records and remote traversal snapshots.                             | [src/storage/codemap.md](./src/storage/codemap.md)             |
